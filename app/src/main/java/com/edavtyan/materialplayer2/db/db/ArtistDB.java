package com.edavtyan.materialplayer2.db.db;
...
import com.edavtyan.materialplayer2.db.CursorIsNullException;
...
public class ArtistDB {
	...
	public List<Artist> searchArtists(String artistTitle) {
		if (Strings.nullOrEmpty(artistTitle)) return Collections.emptyList();
	...
	private List<Artist> getArtistsFromCursor(
		...
		@Cleanup
		Cursor cursor = resolver.query(URI, PROJECTION, selection, args, sort + " COLLATE LOCALIZED");
